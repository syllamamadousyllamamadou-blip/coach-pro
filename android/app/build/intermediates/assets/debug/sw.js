const CACHE_NAME = 'coach-pro-v3.3';
const STATIC_ASSETS = [
  '/',
  '/index.html',
  '/css/style.css',
  ...
  '/js/printer.js',
  '/js/qrGenerator.js',
  '/js/security/license.js',
  '/js/security/pinLock.js',
  '/js/security/backup.js',
  ...
  '/js/components/accounting.js',
  '/js/components/qrScanner.js',
  '/js/components/contractModal.js',
  ...
  '/js/components/recurringSchedule.js',
  '/manifest.json',
  '/icon.svg'
];
