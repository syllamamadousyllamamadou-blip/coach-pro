        ...
        <div class="glass-card p-5 space-y-4">
          <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <div class="grid grid-cols-3 sm:flex sm:flex-wrap items-center gap-1.5 sm:gap-2">
              <button id="btn-open-contract-modal" class="btn btn-primary btn-xs sm:btn-sm flex items-center justify-center gap-1 font-bold shadow-lg shadow-emerald-500/20" title="Signer l'Engagement & Décharge">
                <span>⚖️</span>
                <span>Contrat</span>
              </button>
